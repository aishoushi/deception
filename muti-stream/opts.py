import argparse
parser = argparse.ArgumentParser(description="PyTorch implementation of TSN_merge")
...
parser.add_argument('--dataset', type=str, default='court', choices=['court', 'pandakill'])

...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default='pandakill',
        type=str,
        help='Used dataset (activitynet | kinetics | ucf101 | hmdb51 | court)')
    parser.add_argument(
        '--n_classes',
        default=51,
        type=int,
    ...
    parser.add_argument(
        '--pretrain_path', default='PretrainedModels/resnet-101-kinetics-hmdb51_split1.pth', type=str, help='Pretrained model (.pth)')
    parser.add_argument(
        '--ft_begin_index',
        default=0,
        type=int,
    ...
    parser.add_argument(
        ...
        default='resnet',
        type=str,
        help='(resnet | resnet_2D |preresnet | wideresnet | resnext | densenet | ')
    parser.add_argument(
        '--model_depth',
        default=101,
        type=int,
